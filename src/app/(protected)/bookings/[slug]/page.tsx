...
export default async function BookingDetailPage({ params }: BookingDetailPageProps) {
  ...
  return (
    <div>
      <BackButton href="/bookings"> Details</BackButton>
      <div className=" xl:h-[calc(80vh-11rem)] rounded-2xl mt-[1rem] p-[1.25rem] gap-[2rem] xl:w-full h-full shadow-lg flex flex-col xl:flex-row">
        <div className="w-[25rem] aspect-square overflow-hidden rounded-2xl">
          <img
        ...
        <div className="flex w-full  gap-[1.5rem] flex-col xl:flex-row">
          ...
          <div className="w-full xl:overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <div className="mt-8">
              ...
              <div className="mt-5 grid grid-cols-1 gap-5 md:grid-cols-2">
                {booking.escortCompany.drivers.map((driver) => (
                  <div
                    key={driver.name}
          ...
          <div className="w-[40rem] aspect-square overflow-hidden rounded-2xl">
            <img
