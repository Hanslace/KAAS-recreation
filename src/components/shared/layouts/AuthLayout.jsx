...
export default function AuthLayout() {
  return (
    <main className="min-h-screen w-full md:h-screen md:overflow-hidden">
      <section className="md:grid min-h-screen md:h-full  w-full flex flex-col md:grid-cols-2">
        {/* Left Image */}
        ...
        <div className='custom-scrollbar md:max-h-screen md:overflow-y-auto p-10'>
          <div className=" w-full md:m-auto  space-y-10 md:max-w-[25rem] xl:max-w-[35rem]  ">
